...
<html lang="ko">
  <head>
    ...
    <meta
      content="{sep_keyword1},{sep_keyword2}, 중구변기막힘, 중구변기뚫는업체, 중구하수구막힘, 중구변기수리, 중구싱크대막힘, 변기뚫음, 변기역류"
      name="keywords"
    />
    <meta
      content="{sep_keyword1},{sep_keyword2} 바로 해결해드립니다. 하수구막힘,싱크대막힘,변기뚫음,변기수리,변기역류,변기교체까지 완-벽하게!"
      name="description"
    />
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">

    <link rel="profile" href="https://gmpg.org/xfn/11" />
    <link rel="canonical" href="https://junggu.jianhomecare.com/블로그/{sep_keyword1}-{sep_keyword2}" />
    ...
    <meta
      ...
      content="{sep_keyword1},{sep_keyword2} 바로 해결해드립니다. 하수구막힘,싱크대막힘,변기뚫음,변기수리,변기역류,변기교체까지 완-벽하게!"
    />
    <meta property="og:url" content="https://junggu.jianhomecare.com/블로그/{sep_keyword1}-{sep_keyword2}" />
    ...
    <meta property="og:image:alt" content="중구변기막힘" />
    <meta property="og:image:type" content="image/gif" />
    <meta name="twitter:domain" content="{keywords}">
    
    <meta property="article:section" content="중구변기막힘">
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        <a href="/" class="navbar-brand font-weight-bold text-secondary">
          <span class="text-primary">중구변기막힘</span>
        </a>
        <button
          type="button"
    ...
    <div class="container-fluid bg-primary mb-5">
      ...
      >
        <h3 class="display-3 font-weight-bold text-align-center text-white">중구변기막힘</h3>
      ...
      <div class="row pt-5">
        <div class="col-lg-8">
          ...
          />
            ...
            <h2 class="mb-4" id="section3" style="text-align: center;">중구변기막힘</h2>
            <img
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
          ...
          <div class="mb-5">
            ...
            <div class="d-flex flex-wrap m-n1">
              <a href="https://junggu.jianhomecare.com" class="btn btn-outline-primary m-1">{sep_keyword1}</a>
              <a href="https://junggu.jianhomecare.com" class="btn btn-outline-primary m-1">{sep_keyword2}</a>
   ...
   <a href="tel:010-3463-4474" class="back-to-top"
    ><img src="../img/call.png" width="80px" alt="중구 변기막힘 상담"></a>
...
# 기본 URL 및 출력 폴더 설정
base_url = "https://junggu.jianhomecare.com/"
